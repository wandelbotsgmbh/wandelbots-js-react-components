...
// ✅ For trajectory/collision components, continue using V1 if needed
...
import { NovaClient } from "@wandelbots/nova-js"
import { TrajectoryRenderer, CollisionSceneRenderer } from "@wandelbots/wandelbots-js-react-components/3d"
```
