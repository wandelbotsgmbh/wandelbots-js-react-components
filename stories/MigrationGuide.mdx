...
If you're using trajectory, or collision scene renderers, they still use the V1 API:

```tsx
// These components still use V1
import { NovaClient } from "@wandelbots/nova-js"
import { TrajectoryRenderer } from "@wandelbots/wandelbots-js-react-components/3d"
```
...
- Ensure you're importing from the correct sub-paths: `/core` or `/3d`
