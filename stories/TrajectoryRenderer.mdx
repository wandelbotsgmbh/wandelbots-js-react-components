...
# Trajectory Renderer (API v1)

The `TrajectoryRenderer` component visualizes the planned trajectory of the robot.

This component should be used with [nova-js](https://github.com/wandelbotsgmbh/nova-js). Pass the `GetTrajectoryResponse` from `NovaCellAPIClient.motion.getMotionTrajectory` (API v1) to the component.
