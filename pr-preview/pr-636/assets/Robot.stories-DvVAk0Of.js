import{j as o,r as n}from"./iframe-Ba2IKQt4.js";import{C as l,P as u}from"./PresetEnvironment-DHnwZdyL.js";import{N as f}from"./index-BFBfO7D5.js";import{s as x,r as R,O as g}from"./robotStoryConfig-DQFLZ1yC.js";import{C as h}from"./ConnectedMotionGroup-BXtVF8Hb.js";import{R as y}from"./Robot-2WoYSM4b.js";import"./preload-helper-Dp1pzeXC.js";import"./three.module-IMxEiD3l.js";import"./three.core-EPGyoDIa.js";import"./with-selector-Ce3-9ARN.js";import"./index-Bb8JjhAW.js";import"./context-BQk3xGAI-BYlX17Lw.js";import"./index-BlzXKUI8.js";import"./hooks-BdgpvHHa.js";import"./mobx.esm-D1cTsgoC.js";import"./Line-BDlQwP_l.js";import"./externalizeComponent-D5IOm6I6.js";import"./context-BefEgr-r.js";import"./interpolation-BF0gwwrY.js";import"./novaCompat-2dTa2FyQ.js";const{expect:C,fn:M,waitFor:b}=__STORYBOOK_MODULE_TEST__,K={...x,tags:["!dev"],title:"3D View/Model Visualization/Robot"};function v(e){const[r,m]=n.useState(),p=new f({instanceUrl:"https://mock.example.com"});return n.useEffect(()=>{async function c(){const d=await h.connect(p,"0@mock-ur5e");m(d)}return c(),()=>{R()}},[]),r?o.jsx("div",{style:{width:"100%",height:"100vh",minHeight:"400px",display:"flex",justifyContent:"center",alignItems:"center"},children:o.jsxs(l,{shadows:!0,children:[o.jsx(u,{}),o.jsx(g,{children:o.jsx(y,{...e,connectedMotionGroup:r})})]})}):null}const t={args:{postModelRender:M()},play:async({args:e})=>{await b(()=>C(e.postModelRender,"Failed to load model for example ur5e").toHaveBeenCalled(),{timeout:8e3})},render:e=>o.jsx(v,{...e}),name:"Robot"};var s,a,i;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    postModelRender: fn()
  },
  play: async ({
