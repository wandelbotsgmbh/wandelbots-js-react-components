import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{Ba as n,Gr as r,Kr as i,Ma as a,Mt as o,Nt as s,S as c,ot as l}from"./iframe-C06mTC8J.js";var u,d,f,p,m,h,g,_;t((()=>{r(),o(),u=e(n(),1),c(),d=a(),f={title:`Components/LogPanel`,component:l,tags:[`!dev`],parameters:{docs:{description:{component:`A complete log panel component with built-in state management using MobX. 
...
For detailed syntax reference, see: https://docs.wandelbots.com/wandelscript/syntax`)};return(0,d.jsxs)(s,{spacing:2,sx:{width:800},children:[(0,d.jsx)(s,{direction:`row`,spacing:1,children:(0,d.jsx)(i,{variant:`outlined`,size:`small`,onClick:()=>{if(!t)return;let e=[`Stack trace for robot motion exception:
...
Recommendations: No issues detected. System operating optimally.`],n=e[Math.floor(Math.random()*e.length)];t.addError(n)},disabled:!t,children:`Add Long Message`})}),(0,d.jsx)(l,{...e,onStoreReady:r})]})},args:{height:400},parameters:{docs:{description:{story:`LogPanel demonstrating very long log messages with detailed stack traces, error reports, and system diagnostics. Long messages are automatically wrapped and can be scrolled within the log viewer.`}}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: args => {
