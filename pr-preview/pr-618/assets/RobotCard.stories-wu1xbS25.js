import{r as m,j as e}from"./iframe-DlVyBzpi.js";import{P as p}from"./ProgramControl-tDXBHJFK.js";import{u as $,a as Ne,C as X,P as ee}from"./PresetEnvironment-DmnGoHUh.js";import{o as De}from"./index-Bsgq13ma.js";import{e as Fe}from"./externalizeComponent-CGu16mc7.js";import{P as te}from"./ProgramStateIndicator-BYh64hLV.js";import{R as we}from"./Robot-Dj8f9OXU.js";import{u as je}from"./useTheme-kw-UmSir.js";import{u as Ie}from"./useTranslation-DiLAa0U5.js";import{C as Le}from"./Card-DOMPvW2P.js";import{B as d}from"./Box-qwGWoIt1.js";import{Q as K,V as h,cF as He,b as q}from"./three.core-CGXRouN8.js";import{T as oe}from"./Typography-C2l6Re_h.js";import{D as re}from"./Divider-DgFx0_NV.js";import{B as ae}from"./Button-CwzLgPPM.js";import{M as S}from"./index-C5wSj4hZ.js";import{g as U,a as ze,b as Be}from"./robotStoryConfig-Cx9eS3Km.js";import{S as ke}from"./Stack-Cfn1Rccn.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-7Pk92ygQ.js";import"./SvgIcon-j6zUy6_U.js";import"./PlayArrow-DcQSR1IY.js";import"./three.module-JKIWMgkV.js";import"./with-selector-lPxLBJf6.js";import"./index-Bb8JjhAW.js";import"./mobx.esm-D1cTsgoC.js";import"./context-BQrBuDwe.js";import"./Chip-DYAMO4y1.js";import"./useSlot-DpMwvKlY.js";import"./mergeSlotProps-MiAiPoXo.js";import"./ButtonBase-BZyoBJ6y.js";import"./useTimeout-DT9FEl5p.js";import"./isFocusVisible-B8k4qzLc.js";import"./Paper-BzNUsV-K.js";import"./dividerClasses-CD3T0C7c.js";import"./CircularProgress-umI-wE3P.js";import"./context-BQk3xGAI-CLoR9YCx.js";import"./hooks-DC-6qlcE.js";import"./interpolation-CHW1rXuG.js";import"./Line-rpmFD5se.js";import"./styled-DSPUPZpQ.js";import"./useThemeProps-C-QfhJkQ.js";import"./getThemeProps-cuYpjEUq.js";var y=(function(r){return r[r.NONE=0]="NONE",r[r.START=1]="START",r[r.ACTIVE=2]="ACTIVE",r})(y||{});const j=r=>r&&r.isOrthographicCamera,Ye=r=>r&&r.isBox3,We=r=>1-Math.exp(-5*r)+.007*r,Ve=m.createContext(null);function ne({children:r,maxDuration:n=1,margin:l=1.2,observe:C,fit:u,clip:_,interpolateFunc:A=We,onFit:P}){const L=m.useRef(null),{camera:t,size:V,invalidate:E}=$(),c=$(v=>v.controls),w=m.useRef(P);w.current=P;const R=m.useRef({camPos:new h,camRot:new K,camZoom:1}),o=m.useRef({camPos:void 0,camRot:void 0,camZoom:void 0,camUp:void 0,target:void 0}),x=m.useRef(y.NONE),g=m.useRef(0),[s]=m.useState(()=>new He),M=m.useMemo(()=>{function v(){const a=s.getSize(new h),i=s.getCenter(new h),f=Math.max(a.x,a.y,a.z),b=j(t)?f*4:f/(2*Math.atan(Math.PI*t.fov/360)),O=j(t)?f*4:b/t.aspect,T=l*Math.max(b,O);return{box:s,size:a,center:i,distance:T}}return{getSize:v,refresh(a){if(Ye(a))s.copy(a);else{const i=a||L.current;if(!i)return this;i.updateWorldMatrix(!0,!0),s.setFromObject(i)}if(s.isEmpty()){const i=t.position.length()||10;s.setFromCenterAndSize(new h,new h(i,i,i))}return R.current.camPos.copy(t.position),R.current.camRot.copy(t.quaternion),j(t)&&(R.current.camZoom=t.zoom),o.current.camPos=void 0,o.current.camRot=void 0,o.current.camZoom=void 0,o.current.camUp=void 0,o.current.target=void 0,this},reset(){const{center:a,distance:i}=v(),f=t.position.clone().sub(a).normalize();o.current.camPos=a.clone().addScaledVector(f,i),o.current.target=a.clone();const b=new q().lookAt(o.current.camPos,o.current.target,t.up);return o.current.camRot=new K().setFromRotationMatrix(b),x.current=y.START,g.current=0,this},moveTo(a){return o.current.camPos=Array.isArray(a)?new h(...a):a.clone(),x.current=y.START,g.current=0,this},lookAt({target:a,up:i}){o.current.target=Array.isArray(a)?new h(...a):a.clone(),i?o.current.camUp=Array.isArray(i)?new h(...i):i.clone():o.current.camUp=t.up.clone();const f=new q().lookAt(o.current.camPos||t.position,o.current.target,o.current.camUp);return o.current.camRot=new K().setFromRotationMatrix(f),x.current=y.START,g.current=0,this},to({position:a,target:i}){return this.moveTo(a).lookAt({target:i})},fit(){if(!j(t))return this.reset();let a=0,i=0;const f=[new h(s.min.x,s.min.y,s.min.z),new h(s.min.x,s.max.y,s.min.z),new h(s.min.x,s.min.y,s.max.z),new h(s.min.x,s.max.y,s.max.z),new h(s.max.x,s.max.y,s.max.z),new h(s.max.x,s.max.y,s.min.z),new h(s.max.x,s.min.y,s.max.z),new h(s.max.x,s.min.y,s.min.z)],b=o.current.camPos||t.position,O=o.current.target||(c==null?void 0:c.target),T=o.current.camUp||t.up,N=O?new q().lookAt(b,O,T).setPosition(b).invert():t.matrixWorldInverse;for(const F of f)F.applyMatrix4(N),a=Math.max(a,Math.abs(F.y)),i=Math.max(i,Math.abs(F.x));a*=2,i*=2;const W=(t.top-t.bottom)/a,D=(t.right-t.left)/i;return o.current.camZoom=Math.min(W,D)/l,x.current=y.START,g.current=0,w.current&&w.current(this.getSize()),this},clip(){const{distance:a}=v();return t.near=a/100,t.far=a*100,t.updateProjectionMatrix(),c&&(c.maxDistance=a*10,c.update()),E(),this}}},[s,t,c,l,E]);m.useLayoutEffect(()=>{if(c){const v=()=>{if(c&&o.current.target&&x.current!==y.NONE){const a=new h().setFromMatrixColumn(t.matrix,2),i=R.current.camPos.distanceTo(c.target),f=(o.current.camPos||R.current.camPos).distanceTo(o.current.target),b=(1-g.current)*i+g.current*f;c.target.copy(t.position).addScaledVector(a,-b),c.update()}x.current=y.NONE};return c.addEventListener("start",v),()=>c.removeEventListener("start",v)}},[c]);const G=m.useRef(0);return m.useLayoutEffect(()=>{(C||G.current++===0)&&(M.refresh(),u&&M.reset().fit(),_&&M.clip())},[V,_,u,C,t,c]),Ne((v,a)=>{if(x.current===y.START)x.current=y.ACTIVE,E();else if(x.current===y.ACTIVE){if(g.current+=a/n,g.current>=1)o.current.camPos&&t.position.copy(o.current.camPos),o.current.camRot&&t.quaternion.copy(o.current.camRot),o.current.camUp&&t.up.copy(o.current.camUp),o.current.camZoom&&j(t)&&(t.zoom=o.current.camZoom),t.updateMatrixWorld(),t.updateProjectionMatrix(),c&&o.current.target&&(c.target.copy(o.current.target),c.update()),x.current=y.NONE;else{const i=A(g.current);o.current.camPos&&t.position.lerpVectors(R.current.camPos,o.current.camPos,i),o.current.camRot&&t.quaternion.slerpQuaternions(R.current.camRot,o.current.camRot,i),o.current.camUp&&t.up.set(0,1,0).applyQuaternion(t.quaternion),o.current.camZoom&&j(t)&&(t.zoom=(1-i)*R.current.camZoom+i*o.current.camZoom),t.updateMatrixWorld(),t.updateProjectionMatrix()}E()}}),m.createElement("group",{ref:L},m.createElement(Ve.Provider,{value:M},r))}const Z=Fe(De(({robotName:r,programState:n,safetyState:l,operationMode:C,driveToHomeEnabled:u=!1,onDriveToHomePress:_,onDriveToHomeRelease:A,connectedMotionGroup:P,robotComponent:L=we,customContentComponent:t,className:V})=>{var W;const E=je(),{t:c}=Ie(),[w,R]=m.useState(!1),o=m.useRef(null),x=m.useRef(null),[g,s]=m.useState(!1),[M,G]=m.useState({width:400,height:600}),[v,a]=m.useState(0);m.useEffect(()=>{const D=()=>{if(x.current){const{offsetWidth:J,offsetHeight:Q}=x.current;s(J>Q),G({width:J,height:Q})}};D();const F=new ResizeObserver(D);return x.current&&F.observe(x.current),()=>{F.disconnect()}},[]);const i=m.useCallback(()=>{a(D=>D+1)},[]),f=m.useCallback(()=>{!u||!_||(R(!0),_())},[u,_]),b=m.useCallback(()=>{!u||!A||(R(!1),A())},[u,A]),O=m.useCallback(()=>{w&&A&&(R(!1),A())},[w,A]),T=g?M.width<350:M.height<200,N=g?M.height<310:M.height<450;return e.jsx(Le,{ref:x,className:V,sx:{width:"100%",height:"100%",display:"flex",flexDirection:g?"row":"column",position:"relative",overflow:"hidden",minWidth:{xs:180,sm:220,md:250},minHeight:g?{xs:200,sm:240,md:260}:{xs:150,sm:180,md:220},border:`1px solid ${E.palette.divider}`,borderRadius:"18px",boxShadow:"none",backgroundColor:((W=E.palette.backgroundPaperElevation)==null?void 0:W[8])||"#2A2A3F",backgroundImage:"none"},children:g?e.jsxs(e.Fragment,{children:[e.jsx(d,{sx:{flex:"0 0 50%",position:"relative",height:"100%",minHeight:"100%",maxHeight:"100%",borderRadius:1,m:{xs:1.5,sm:2,md:3},mr:{xs:.75,sm:1,md:1.5},overflow:"hidden",display:T?"none":"block"},children:!T&&e.jsxs(X,{orthographic:!0,camera:{position:[3,2,3],zoom:1},shadows:!0,frameloop:"demand",style:{borderRadius:E.shape.borderRadius,width:"100%",height:"100%",background:"transparent",position:"absolute",top:0,left:0},dpr:[1,2],gl:{alpha:!0,antialias:!0},children:[e.jsx(ee,{}),e.jsx(ne,{fit:!0,observe:!0,margin:1,maxDuration:1,children:e.jsx(L,{connectedMotionGroup:P,postModelRender:i})})]})}),e.jsxs(d,{sx:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"flex-start",width:T?"100%":"50%"},children:[e.jsxs(d,{sx:{p:{xs:1.5,sm:2,md:3},pb:{xs:1,sm:1.5,md:2},textAlign:"left"},children:[e.jsx(oe,{variant:"h6",component:"h2",sx:{mb:1},children:r}),e.jsx(te,{programState:n,safetyState:l,operationMode:C})]}),e.jsxs(d,{sx:{p:{xs:1.5,sm:2,md:3},pt:0,flex:"1",display:"flex",flexDirection:"column",justifyContent:"space-between"},children:[!N&&t&&e.jsxs(d,{children:[e.jsx(t,{}),e.jsx(re,{sx:{mt:1,mb:0,borderColor:E.palette.divider,opacity:.5}})]}),e.jsx(d,{sx:{mt:!N&&t?"auto":0},children:e.jsx(d,{sx:{display:"flex",justifyContent:"flex-start",mt:{xs:1,sm:1.5,md:2},mb:{xs:.5,sm:.75,md:1}},children:e.jsx(ae,{ref:o,variant:"contained",color:"secondary",size:"small",disabled:!u,onMouseDown:f,onMouseUp:b,onMouseLeave:O,onTouchStart:f,onTouchEnd:b,sx:{textTransform:"none",px:1.5,py:.5},children:c("RobotCard.DriveToHome.bt")})})})]})]})]}):e.jsx(e.Fragment,{children:e.jsxs(d,{sx:{p:3,height:"100%",display:"flex",flexDirection:"column"},children:[e.jsxs(d,{children:[e.jsx(oe,{variant:"h6",component:"h2",sx:{mb:1},children:r}),e.jsx(te,{programState:n,safetyState:l,operationMode:C})]}),e.jsx(d,{sx:{flex:T?0:1,position:"relative",minHeight:T?0:{xs:120,sm:150,md:200},height:T?0:"auto",borderRadius:1,overflow:"hidden",display:T?"none":"block"},children:!T&&e.jsxs(X,{orthographic:!0,camera:{position:[3,2,3],zoom:1},shadows:!0,frameloop:"demand",style:{borderRadius:E.shape.borderRadius,width:"100%",height:"100%",background:"transparent",position:"absolute"},dpr:[1,2],gl:{alpha:!0,antialias:!0},children:[e.jsx(ee,{}),e.jsx(ne,{fit:!0,clip:!0,observe:!0,margin:1,maxDuration:1,children:e.jsx(L,{connectedMotionGroup:P,postModelRender:i})})]})}),e.jsxs(d,{children:[!N&&t&&e.jsxs(e.Fragment,{children:[e.jsx(t,{}),e.jsx(re,{sx:{mt:1,mb:0,borderColor:E.palette.divider,opacity:.5}})]}),e.jsx(d,{sx:{display:"flex",justifyContent:"flex-start",mt:!N&&t?{xs:1,sm:2,md:5}:{xs:.5,sm:1,md:2},mb:{xs:.5,sm:.75,md:1}},children:e.jsx(ae,{ref:o,variant:"contained",color:"secondary",size:"small",disabled:!u,onMouseDown:f,onMouseUp:b,onMouseLeave:O,onTouchStart:f,onTouchEnd:b,sx:{textTransform:"none",px:1.5,py:.5},children:c("RobotCard.DriveToHome.bt")})})]})]})})})}));try{Z.displayName="RobotCard",Z.__docgenInfo={description:`A responsive card component that displays a 3D robot with states and controls.
...
content on the right with left-aligned text elements.`,...(Ce=(ve=k.parameters)==null?void 0:ve.docs)==null?void 0:Ce.description}}};var Me,_e,Pe,Oe,Ue;Y.parameters={...Y.parameters,docs:{...(Me=Y.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
...
}`,...(Pe=(_e=Y.parameters)==null?void 0:_e.docs)==null?void 0:Pe.source},description:{story:`Test responsive behavior with a resizable container.
Drag the resize handle to see how the robot scales and eventually hides at small sizes.
The component maintains consistent padding while making the 3D robot responsive.`,...(Ue=(Oe=Y.parameters)==null?void 0:Oe.docs)==null?void 0:Ue.description}}};const Ht=["Basic","MultipleRobots","CompactSize","LandscapeLayout","ResizableTest"];export{H as Basic,B as CompactSize,k as LandscapeLayout,z as MultipleRobots,Y as ResizableTest,Ht as __namedExportsOrder,Lt as default};
