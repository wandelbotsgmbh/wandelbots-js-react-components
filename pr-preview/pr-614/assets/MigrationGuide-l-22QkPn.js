import{j as n,M as s}from"./iframe-DOikaZn2.js";import{useMDXComponents as r}from"./index-Cab0K6UI.js";import"./preload-helper-Dp1pzeXC.js";function t(e){const o={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...e.components};return n.jsxs(n.Fragment,{children:[n.jsx(s,{title:"Migration Guide"}),`
...
`,n.jsxs(o.li,{children:[n.jsx(o.strong,{children:"Initialization"}),": Use the static ",n.jsx(o.code,{children:"connect"})," method with a ",n.jsx(o.code,{children:"Nova"})," instance and motion group ID"]}),`
`]}),`
...
`,n.jsxs(o.ul,{children:[`
`,n.jsxs(o.li,{children:[n.jsx(o.strong,{children:"Nova or string"}),": Many components now accept either a ",n.jsx(o.code,{children:"Nova"})," instance or a URL string for the ",n.jsx(o.code,{children:"nova"})," prop"]}),`
...
`]}),`
`,n.jsx(o.pre,{children:n.jsx(o.code,{className:"language-tsx",children:`// ✅ Option 1: Pass Nova instance
...
const nova = new Nova({ instanceUrl: "https://your-instance.com" })
...
<JoggingPanel nova={nova} motionGroupId="0@ur5e" />
`})}),`
`,n.jsxs(o.h2,{id:"breaking-changes-from-5x-to-6x-nova-replaces-novaclient",children:["Breaking Changes from 5.x to 6.x (",n.jsx(o.code,{children:"Nova"})," replaces ",n.jsx(o.code,{children:"NovaClient"}),")"]}),`
`,n.jsxs(o.p,{children:["This library now uses the new ",n.jsx(o.code,{children:"Nova"})," client from ",n.jsx(o.code,{children:"@wandelbots/nova-js/v2"}),". The deprecated ",n.jsx(o.code,{children:"NovaClient"})," baked in a cell id and exposed cell-scoped API methods; ",n.jsx(o.code,{children:"Nova"})," is cell-agnostic and every cell-scoped API method now takes the cell id as its first argument."]}),`
`,n.jsxs(o.p,{children:["Components and helpers that previously accepted a ",n.jsx(o.code,{children:"NovaClient"})," now accept a ",n.jsx(o.code,{children:"Nova"})," instance (or a URL string) and an optional ",n.jsx(o.code,{children:"cellId"})," (defaulting to ",n.jsx(o.code,{children:'"cell"'}),")."]}),`
`,n.jsx(o.pre,{children:n.jsx(o.code,{className:"language-tsx",children:`// Before
import { NovaClient } from "@wandelbots/nova-js/v2"
...
import { Nova } from "@wandelbots/nova-js/v2"
const nova = new Nova({ instanceUrl: "https://your-nova-instance.com" })
<JoggingPanel nova={nova} motionGroupId="0@ur5e" cellId="cell" />
`})}),`
`,n.jsxs(o.p,{children:["Affected helpers (",n.jsx(o.code,{children:"cellId"})," accepted as an option):"]}),`
`,n.jsxs(o.ul,{children:[`
`,n.jsx(o.li,{children:n.jsx(o.code,{children:"ConnectedMotionGroup.connect(nova, motionGroupId, { cellId })"})}),`
`,n.jsx(o.li,{children:n.jsx(o.code,{children:"ConnectedMotionGroup.connectMultiple(nova, motionGroupIds, { cellId })"})}),`
`,n.jsx(o.li,{children:n.jsx(o.code,{children:"MotionStreamConnection.open(nova, motionGroupId, { cellId })"})}),`
`,n.jsx(o.li,{children:n.jsx(o.code,{children:"JoggerConnection.open(nova, motionGroupId, { cellId, ... })"})}),`
`]}),`
