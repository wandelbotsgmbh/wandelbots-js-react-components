import{j as n,r as u,R as F}from"./iframe-CTXJna5z.js";import{o as ae}from"./index-Blpsr57i.js";import{e as se}from"./externalizeComponent-CG2_aJmX.js";import{u as ne}from"./useTranslation-lTCtwxeZ.js";import{u as re}from"./useTheme-DNYSHzv7.js";import{B as R}from"./Box-CJqBV3my.js";import{G as oe}from"./Gauge-Ck_YdvbU.js";import{F as A}from"./Fade-C6-zWtrx.js";import{T as P}from"./Typography-ChVS9r8q.js";import{u as ie}from"./interpolation-2eqcPcHB.js";import{B as y}from"./Button-DbqO249p.js";import"./preload-helper-Dp1pzeXC.js";import"./mobx.esm-DvxsEwe8.js";import"./context-D710SZCY.js";import"./ButtonBase-DjbfjuLU.js";import"./useTimeout-DlxaCm6p.js";import"./isFocusVisible-B8k4qzLc.js";import"./fastObjectShallowCompare-CnZs-ixg.js";import"./with-selector-jgdepzMk.js";import"./ownerWindow-HkKU3E4x.js";import"./ownerDocument-DW-IO8s5.js";import"./useThemeProps-CjyaSlQl.js";import"./getThemeProps-Bv2vVnUP.js";import"./utils-CYH3bSy_.js";import"./CircularProgress-Dy51q-Vj.js";const le=d=>{const s=Math.floor(d/86400),t=Math.floor(d%86400/3600),m=Math.floor(d%3600/60),a=d%60,i=[];return s>0?(i.push(s.toString()),i.push(t.toString().padStart(2,"0")),i.push(m.toString().padStart(2,"0")),i.push(a.toString().padStart(2,"0"))):t>0?(i.push(t.toString()),i.push(m.toString().padStart(2,"0")),i.push(a.toString().padStart(2,"0"))):(i.push(m.toString()),i.push(a.toString().padStart(2,"0"))),i.join(":")},I=(d,s)=>{const t=Math.floor(d/86400),m=Math.floor(d%86400/3600),a=Math.floor(d%3600/60),i=d%60;if(typeof Intl<"u"&&"DurationFormat"in Intl)try{const r={};return t>0&&(r.days=t),m>0&&(r.hours=m),a>0&&(r.minutes=a),(i>0||Object.keys(r).length===0)&&(r.seconds=i),new Intl.DurationFormat(s,{style:"narrow"}).format(r)}catch{}const l=[];return t>0&&l.push(`${t}d`),m>0&&l.push(`${m}h`),a>0&&l.push(`${a}m`),(i>0||l.length===0)&&l.push(`${i}s`),l.join(" ")},ce=(d,s,t)=>d==="countdown"&&t!==null?Math.min(100,s/t*100):d==="measuring"?s/60%1*100:0,W=({timerState:d,animationState:s,hasError:t,className:m})=>{const{t:a,i18n:i}=ne(),l=re(),{currentState:r,remainingTime:e,maxTime:o,currentProgress:x}=d,{showErrorAnimation:g,showPauseAnimation:w,showPulsatingText:f,pulsatingFinished:C,showLabels:b,showMainText:T,showIdlePulsating:j,idleDotsCount:M}=s;return n.jsxs(R,{className:m,sx:{position:"relative",width:264,height:264,display:"flex",alignItems:"center",justifyContent:"center"},children:[n.jsx(oe,{width:264,height:264,value:r==="idle"?0:x,valueMin:0,valueMax:100,innerRadius:"85%",outerRadius:"100%",margin:0,skipAnimation:!0,text:()=>"",sx:{opacity:w||g?.6:1,transition:"opacity 0.5s ease-out","& .MuiGauge-valueArc":{fill:t?l.palette.error.light:l.palette.success.main,transition:"fill 0.5s ease-out"},"& .MuiGauge-referenceArc":{fill:"#171927",stroke:"transparent",strokeWidth:0,transition:"fill 0.5s ease-out, stroke 0.5s ease-out, stroke-width 0.5s ease-out"},"& .MuiGauge-valueText":{display:"none"},"& .MuiGauge-text":{display:"none"}}}),n.jsxs(R,{sx:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:225,height:225,borderRadius:"50%",backgroundColor:"#292B3F",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",gap:1,transition:"background-color 0.5s ease-out"},children:[n.jsx(R,{sx:{height:"16px",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:1},children:n.jsx(A,{in:b&&!t&&r!=="idle"&&r!=="success",timeout:300,children:n.jsx(P,{variant:"body2",sx:{fontSize:"12px",color:r==="measured"&&(f||C)?l.palette.success.main:l.palette.text.secondary,transition:"color 0.8s ease-in-out"},children:n.jsx("span",{style:{opacity:r==="measured"&&C?f?1:.6:1,transition:"opacity 2s ease-in-out"},children:r==="measuring"||r==="measured"?a("CycleTimer.CycleTime.lb","Cycle Time"):r==="countdown"?a("CycleTimer.RemainingTime.lb","Remaining Time"):""})})})}),n.jsxs(R,{sx:{position:"relative",height:"48px",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:.5},children:[n.jsx(A,{in:T&&r==="idle"&&!t,timeout:200,children:n.jsxs(P,{variant:"body2",sx:{position:"absolute",fontSize:"12px",fontWeight:400,color:"rgba(255, 255, 255, 0.7)",lineHeight:"166%",letterSpacing:"0.17px",textAlign:"center",width:"200px",height:"20px",display:"flex",alignItems:"center",justifyContent:"center"},children:[n.jsx("span",{style:{opacity:j?1:.6,transition:"opacity 2s ease-in-out"},children:a("CycleTimer.WaitingForCycle.lb","Waiting for program cycle")}),n.jsx("span",{style:{display:"inline-block",width:"18px",textAlign:"left",opacity:j?1:.6,transition:"opacity 2s ease-in-out"},children:".".repeat(M)})]})}),n.jsx(A,{in:T&&t,timeout:200,children:n.jsx(P,{variant:"h3",sx:{position:"absolute",fontSize:"40px",fontWeight:400,color:"#FFFFFF",lineHeight:"116.7%"},children:a("CycleTimer.Error.lb","Error")})}),n.jsx(A,{in:T&&!t&&r!=="idle"&&r!=="success",timeout:300,children:n.jsx(P,{variant:"h1",sx:{position:"absolute",fontSize:"48px",fontWeight:500,color:l.palette.text.primary,lineHeight:1,transition:"color 0.8s ease-in-out"},children:n.jsx("span",{style:{opacity:1,transition:"opacity 2s ease-in-out"},children:le(e)})})})]}),n.jsx(R,{sx:{height:"16px",display:"flex",marginTop:.5,alignItems:"center",justifyContent:"center"},children:n.jsx(A,{in:b&&!t&&r!=="idle"&&r!=="success",timeout:300,children:n.jsx(P,{variant:"body2",sx:{fontSize:"12px",color:r==="measured"&&(f||C)?l.palette.success.main:l.palette.text.secondary,transition:"color 0.8s ease-in-out"},children:n.jsx("span",{style:{opacity:r==="measured"&&C?f?1:.6:1,transition:"opacity 2s ease-in-out"},children:r==="measuring"?a("CycleTimer.Measuring.lb","measuring..."):r==="measured"?a("CycleTimer.Determined.lb","determined"):r==="countdown"&&o!==null?a("CycleTimer.OfTime.lb",{time:I(o,i.language)}):""})})})})]})]})};try{W.displayName="DefaultVariant",W.__docgenInfo={description:"",displayName:"DefaultVariant",props:{timerState:{defaultValue:null,description:"",name:"timerState",required:!0,type:{name:"TimerState"}},animationState:{defaultValue:null,description:"",name:"animationState",required:!0,type:{name:"AnimationState"}},hasError:{defaultValue:null,description:"",name:"hasError",required:!0,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const H=({timerState:d,animationState:s,hasError:t,compact:m,className:a})=>{const{t:i,i18n:l}=ne(),r=re(),{currentState:e,remainingTime:o,maxTime:x}=d,{showErrorAnimation:g,showPauseAnimation:w,showPulsatingText:f,pulsatingFinished:C,showIdlePulsating:b,idleDotsCount:T}=s;return m&&e==="idle"?n.jsx(R,{className:a,sx:{display:"flex",alignItems:"center",m:0},children:n.jsx(P,{variant:"body2",sx:{color:t?r.palette.error.light:r.palette.text.primary,fontSize:"14px",transition:"color 0.5s ease-out"},children:t?i("CycleTimer.Error.lb","Error"):e==="idle"?"0s":I(o,l.language)})}):n.jsxs(R,{className:a,sx:{display:"flex",alignItems:"center",m:0,gap:1},children:[!(e==="idle"&&m)&&n.jsx(R,{sx:{width:20,height:20,display:"flex",alignItems:"center",justifyContent:"center",opacity:w||g?.6:1,transition:"opacity 0.5s ease-out"},children:n.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 20 20",style:{transform:"rotate(-90deg)"},role:"img","aria-label":"Timer progress",children:[n.jsx("circle",{cx:"10",cy:"10",r:"8",fill:"none",stroke:t?r.palette.error.light:e==="measured"?f||C?r.palette.success.main:r.palette.text.secondary:r.palette.success.main,strokeWidth:"2",opacity:e==="measured"&&C?f?1:.6:.3,style:{transition:"stroke 0.8s ease-in-out, opacity 2s ease-in-out"}}),n.jsx("circle",{cx:"10",cy:"10",r:"8",fill:"none",stroke:t?r.palette.error.light:e==="measured"?f||C?r.palette.success.main:r.palette.text.secondary:r.palette.success.main,strokeWidth:"2",strokeLinecap:"round",strokeDasharray:`${2*Math.PI*8}`,strokeDashoffset:`${2*Math.PI*8*(1-(e==="idle"?0:d.currentProgress)/100)}`,style:{opacity:e==="measured"&&C?f?1:.6:1,transition:"stroke-dashoffset 0.1s ease-out, stroke 0.8s ease-in-out, opacity 2s ease-in-out"}})]})}),n.jsx(P,{variant:"body2",sx:{color:t?r.palette.error.light:e==="idle"?"rgba(255, 255, 255, 0.7)":e==="measured"?f||C?r.palette.success.main:r.palette.text.secondary:r.palette.text.primary,fontSize:"14px",lineHeight:"normal",letterSpacing:"normal",opacity:e==="idle"?b?1:.6:e==="measured"&&C?f?1:.6:1,transition:"color 0.8s ease-in-out, font-size 0.3s ease-out, opacity 2s ease-in-out"},children:t?i("CycleTimer.Error.lb","Error"):e==="idle"?n.jsxs(n.Fragment,{children:[n.jsx("span",{children:i("CycleTimer.WaitingForCycle.lb","Waiting for program cycle")}),n.jsx("span",{style:{display:"inline-block",width:"18px",textAlign:"left"},children:".".repeat(T)})]}):e==="measuring"?m?I(o,l.language):`${I(o,l.language)} / ${i("CycleTimer.Measuring.lb","measuring...")}`:e==="measured"?m?I(o,l.language):`${I(o,l.language)} / ${i("CycleTimer.Determined.lb","determined")}`:e==="countdown"&&x!==null?m?I(o,l.language):`${I(o,l.language)} / ${i("CycleTimer.Time.lb",{time:I(x,l.language)})}`:I(o,l.language)})]})};try{H.displayName="SmallVariant",H.__docgenInfo={description:"",displayName:"SmallVariant",props:{timerState:{defaultValue:null,description:"",name:"timerState",required:!0,type:{name:"TimerState"}},animationState:{defaultValue:null,description:"",name:"animationState",required:!0,type:{name:"AnimationState"}},hasError:{defaultValue:null,description:"",name:"hasError",required:!0,type:{name:"boolean"}},compact:{defaultValue:null,description:"",name:"compact",required:!0,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const ue=()=>{const[d,s]=u.useState({showPauseAnimation:!1,showErrorAnimation:!1,showPulsatingText:!1,pulsatingFinished:!1,showLabels:!0,showMainText:!0,showIdlePulsating:!1,idleDotsCount:0}),t=u.useRef(null),m=u.useRef(null),a=u.useRef(null),i=u.useRef(null),l=u.useRef(0),r=u.useRef(null),e=u.useRef(null),o=u.useCallback(()=>{s(c=>({...c,showPauseAnimation:!0})),t.current&&clearTimeout(t.current),t.current=setTimeout(()=>{s(c=>({...c,showPauseAnimation:!1}))},800)},[]),x=u.useCallback(()=>{s(c=>({...c,showErrorAnimation:!0})),m.current&&clearTimeout(m.current),m.current=setTimeout(()=>{s(c=>({...c,showErrorAnimation:!1}))},600)},[]),g=u.useCallback(()=>{s(c=>({...c,showErrorAnimation:!1})),m.current&&clearTimeout(m.current)},[]),w=u.useCallback(c=>{l.current=0,s(S=>({...S,showPulsatingText:!0,pulsatingFinished:!1})),setTimeout(()=>{s(S=>({...S,pulsatingFinished:!0})),a.current=setInterval(()=>{s(S=>({...S,showPulsatingText:!S.showPulsatingText}))},2e3),c&&c()},800)},[]),f=u.useCallback(()=>{a.current&&(clearInterval(a.current),a.current=null),s(c=>({...c,showPulsatingText:!1,pulsatingFinished:!1})),l.current=0},[]),C=u.useCallback(()=>{s(c=>({...c,showIdlePulsating:!0})),r.current=setInterval(()=>{s(c=>({...c,showIdlePulsating:!c.showIdlePulsating}))},2e3),e.current=setInterval(()=>{s(c=>({...c,idleDotsCount:(c.idleDotsCount+1)%4}))},800)},[]),b=u.useCallback(()=>{r.current&&(clearInterval(r.current),r.current=null),e.current&&(clearInterval(e.current),e.current=null),s(c=>({...c,showIdlePulsating:!1,idleDotsCount:0}))},[]),T=u.useCallback(()=>{s(c=>({...c,showLabels:!1,showMainText:!1})),i.current&&clearTimeout(i.current),i.current=setTimeout(()=>{s(c=>({...c,showLabels:!0,showMainText:!0}))},200)},[]),j=u.useCallback(()=>{s(c=>({...c,showLabels:!0,showMainText:!0}))},[]),M=u.useCallback(()=>{t.current&&clearTimeout(t.current),m.current&&clearTimeout(m.current),i.current&&clearTimeout(i.current),a.current&&clearInterval(a.current),r.current&&clearInterval(r.current),e.current&&clearInterval(e.current)},[]);return{animationState:d,triggerPauseAnimation:o,triggerErrorAnimation:x,clearErrorAnimation:g,startPulsatingAnimation:w,stopPulsatingAnimation:f,startIdleAnimations:C,stopIdleAnimations:b,triggerFadeTransition:T,setInitialAnimationState:j,cleanup:M}},me=({autoStart:d,onCycleEnd:s,onMeasuringComplete:t,hasError:m,onPauseAnimation:a,onErrorAnimation:i,onClearErrorAnimation:l,onStartPulsating:r})=>{const[e,o]=u.useState({currentState:"idle",remainingTime:0,maxTime:null,isRunning:!1,isPausedState:!1,currentProgress:0,wasRunningBeforeError:!1}),x=u.useRef(null),g=u.useRef(null),w=u.useRef(0),[f]=ie([0],{tension:80,friction:18,onChange:([p])=>{o(h=>({...h,currentProgress:p}))}}),C=u.useCallback(()=>{o(p=>({...p,currentState:"idle",maxTime:null,isRunning:!1,isPausedState:!1,currentProgress:0})),w.current=0,g.current=null,f.setImmediate([0])},[f]),b=u.useCallback((p=0)=>{const h=p/60%1*100;o(v=>({...v,currentState:"measuring",maxTime:null,remainingTime:p,isPausedState:!1,currentProgress:h})),w.current=0,f.setImmediate([h]),d?(g.current=Date.now()-p*1e3,o(v=>({...v,isRunning:!0}))):g.current=null},[d,f]),T=u.useCallback((p,h=0)=>{o(k=>({...k,isRunning:!1})),g.current=null,o(k=>({...k,currentState:"countdown",maxTime:p,isPausedState:!1})),w.current=0;const v=Math.max(0,p-h),B=h>0?h/p*100:0;o(k=>({...k,remainingTime:v,currentProgress:B})),f.setImmediate([B]),v===0?(o(k=>({...k,isRunning:!1})),g.current=null,s&&queueMicrotask(()=>s())):d?setTimeout(()=>{g.current=Date.now()-h*1e3,o(k=>({...k,isRunning:!0}))},0):g.current=null},[d,s,f]),j=u.useCallback(()=>{o(p=>({...p,isRunning:!1,currentState:"measured"})),g.current=null,r(()=>{t&&t()})},[r,t]),M=u.useCallback(()=>{if(g.current&&e.isRunning){const h=Date.now()-g.current;w.current+=h;const v=w.current/1e3,B=ce(e.currentState,v,e.maxTime);f.setTarget([B])}o(p=>({...p,isRunning:!1,isPausedState:!0})),a()},[e.isRunning,e.currentState,e.maxTime,f,a]),c=u.useCallback(()=>{e.isPausedState&&(e.remainingTime>0||e.currentState!=="countdown")&&(g.current=Date.now(),o(p=>({...p,isRunning:!0,isPausedState:!1})))},[e.isPausedState,e.remainingTime,e.currentState]),S=u.useCallback(()=>e.isPausedState,[e.isPausedState]);return u.useEffect(()=>{m?(e.isRunning&&!e.isPausedState&&(o(p=>({...p,wasRunningBeforeError:!0})),M()),i()):(e.wasRunningBeforeError&&e.isPausedState&&(o(p=>({...p,wasRunningBeforeError:!1})),c()),l())},[m,e.isRunning,e.isPausedState,e.wasRunningBeforeError,M,c,i,l]),u.useEffect(()=>{if(e.isRunning){const p=()=>{if(g.current){const v=(Date.now()-g.current+w.current)/1e3;if(e.currentState==="countdown"&&e.maxTime!==null){const B=Math.max(0,e.maxTime-v);o(V=>({...V,remainingTime:Math.ceil(B)}));const k=Math.min(100,v/e.maxTime*100);if(f.setTarget([k]),B<=0){o(V=>({...V,isRunning:!1,remainingTime:0})),g.current=null,f.setTarget([100]),s&&queueMicrotask(()=>s());return}}else if(e.currentState==="measuring"){o(k=>({...k,remainingTime:Math.floor(v)}));const B=v/60%1*100;f.setTarget([B])}e.isRunning&&(x.current=requestAnimationFrame(p))}};x.current=requestAnimationFrame(p)}else x.current&&(cancelAnimationFrame(x.current),x.current=null);return()=>{x.current&&cancelAnimationFrame(x.current)}},[e.isRunning,s,e.currentState,e.maxTime,f]),u.useEffect(()=>{let p=null;const h=()=>{f.update(1/60),p=requestAnimationFrame(h)};return p=requestAnimationFrame(h),()=>{p&&cancelAnimationFrame(p)}},[f]),{timerState:e,controls:{startNewCycle:T,startMeasuring:b,setIdle:C,completeMeasuring:j,pause:M,resume:c,isPaused:S}}},z=se(ae(({onCycleComplete:d,onCycleEnd:s,onMeasuringComplete:t,autoStart:m=!0,variant:a="default",compact:i=!1,className:l,hasError:r=!1})=>{const e=u.useRef(void 0),{animationState:o,triggerPauseAnimation:x,triggerErrorAnimation:g,clearErrorAnimation:w,startPulsatingAnimation:f,stopPulsatingAnimation:C,startIdleAnimations:b,stopIdleAnimations:T,triggerFadeTransition:j,setInitialAnimationState:M,cleanup:c}=ue(),{timerState:S,controls:p}=me({autoStart:m,onCycleEnd:s,onMeasuringComplete:t,hasError:r,onPauseAnimation:x,onErrorAnimation:g,onClearErrorAnimation:w,onStartPulsating:f});return u.useEffect(()=>{const h=e.current;e.current!==void 0&&h!==S.currentState?(h==="measured"&&C(),h==="idle"&&T(),j()):M(),S.currentState==="idle"&&b(),e.current=S.currentState},[S.currentState,C,T,b,j,M]),u.useEffect(()=>{let h=!0;const v=setTimeout(()=>{h&&d(p)},0);return()=>{h=!1,clearTimeout(v)}},[d,p]),u.useEffect(()=>c,[c]),a==="small"?n.jsx(H,{timerState:S,animationState:o,hasError:r,compact:i,className:l}):n.jsx(W,{timerState:S,animationState:o,hasError:r,className:l})}));try{z.displayName="CycleTimer",z.__docgenInfo={description:`A circular gauge timer component for cycle-specific timing operations
...
Perfect for space-constrained UIs where you need just the essential time display.`,...(te=(ee=N.parameters)==null?void 0:ee.docs)==null?void 0:te.description}}};const Ve=["Default","SmallVariant","CompactVariant"];export{N as CompactVariant,E as Default,D as SmallVariant,Ve as __namedExportsOrder,Fe as default};
