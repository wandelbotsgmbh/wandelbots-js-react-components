import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{Ba as n,D as r,Di as i,Gr as a,Kr as o,Ma as s,O as c,Oi as l}from"./iframe-B6q2Ff5u.js";var u,d,f,p,m,h,g;t((()=>{i(),a(),u=e(n(),1),c(),d=s(),f={title:`Components/Timer`,component:r,tags:[`!dev`],parameters:{layout:`centered`,docs:{description:{component:`
...
- \`isPaused()\` - Check pause state
        `},story:{inline:!1,iframeHeight:400}}},args:{autoStart:!0,onTimerReady:()=>{}},argTypes:{onTimerReady:{action:`onTimerReady`,description:`Callback that receives timer control functions (start, pause, resume, reset, isPaused)`},autoStart:{control:`boolean`,description:`Whether the timer should start automatically when initialized`,table:{defaultValue:{summary:`true`}}},variant:{control:`select`,options:[`default`,`small`],description:`Visual variant: 'default' (large gauge) or 'small' (animated icon with text)`,table:{defaultValue:{summary:`default`}}},compact:{control:`boolean`,description:`For small variant: whether to show compact display`,table:{defaultValue:{summary:`false`}}},className:{control:`text`,description:`Additional CSS classes`},hasError:{control:`boolean`,description:`Whether the timer is in an error state (pauses timer and shows error styling)`,table:{defaultValue:{summary:`false`}}}}},p={args:{autoStart:!0},render:function(e){let[t,n]=u.useState(!1),i=u.useRef(null),a=t=>{i.current=t,e.onTimerReady(t)},s=()=>{i.current&&i.current.start()},c=()=>{i.current&&i.current.start(45)},f=()=>{i.current&&i.current.pause()},p=()=>{i.current&&i.current.resume()},m=()=>{i.current&&i.current.reset()},h=()=>{n(!t)};return(0,d.jsxs)(l,{sx:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:3},children:[(0,d.jsx)(r,{...e,onTimerReady:a,hasError:t}),(0,d.jsxs)(l,{sx:{display:`flex`,gap:1,flexWrap:`wrap`,justifyContent:`center`},children:[(0,d.jsx)(o,{variant:`contained`,onClick:s,size:`small`,children:`Start Fresh`}),(0,d.jsx)(o,{variant:`contained`,onClick:c,size:`small`,children:`Start from 45s`}),(0,d.jsx)(o,{variant:`outlined`,onClick:f,size:`small`,children:`Pause`}),(0,d.jsx)(o,{variant:`outlined`,onClick:p,size:`small`,children:`Resume`}),(0,d.jsx)(o,{variant:`outlined`,onClick:m,size:`small`,children:`Reset`}),(0,d.jsx)(o,{variant:t?`contained`:`outlined`,color:`error`,onClick:h,size:`small`,children:t?`Clear Error`:`Trigger Error`})]})]})}},m={args:{variant:`small`,autoStart:!0},render:function(e){let t=u.useRef(null),n=n=>{t.current=n,e.onTimerReady(n)},i=()=>{t.current&&t.current.reset()},a=()=>{t.current&&t.current.start()};return(0,d.jsxs)(l,{sx:{display:`flex`,flexDirection:`column`,alignItems:`flex-start`,gap:3},children:[(0,d.jsx)(r,{...e,onTimerReady:n}),(0,d.jsxs)(l,{sx:{display:`flex`,gap:1},children:[(0,d.jsx)(o,{variant:`contained`,onClick:a,size:`small`,children:`Start`}),(0,d.jsx)(o,{variant:`outlined`,onClick:i,size:`small`,children:`Reset`})]})]})}},h={args:{variant:`small`,compact:!0,autoStart:!0},render:function(e){let t=u.useRef(null),n=n=>{t.current=n,e.onTimerReady(n)},i=()=>{t.current&&t.current.reset()},a=()=>{t.current&&t.current.start()};return(0,d.jsxs)(l,{sx:{display:`flex`,flexDirection:`column`,alignItems:`flex-start`,gap:2},children:[(0,d.jsx)(r,{...e,onTimerReady:n}),(0,d.jsxs)(l,{sx:{display:`flex`,gap:1},children:[(0,d.jsx)(o,{variant:`contained`,onClick:a,size:`small`,children:`Start`}),(0,d.jsx)(o,{variant:`outlined`,onClick:i,size:`small`,children:`Reset`})]})]})}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    autoStart: true
  },
